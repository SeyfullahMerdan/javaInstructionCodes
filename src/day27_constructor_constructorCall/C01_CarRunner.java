...
public class C01_CarRunner {
	...
	public static void main(String[] args) {
		...
		car1.km=75000;
		car1.model="Corolla";          // car1 objesi için deger verdik. 
		car1.renk="Kirmizi";
		System.out.println(car1.km +" " + car1.model + " " + car1.renk + " " + car1.yil+" " + car1.satilikMi);
		...
		// 0 null null 2000 false        // Her objeye tekrar tekar deger vermek gerek aksi takdirde default deger verir.
		                             
		Car1 car3=new Car1();  // Car1 classýndan Car3 diye bir obje oluþturdum.
		car3.km=40000;
		car3.satilikMi=true;
