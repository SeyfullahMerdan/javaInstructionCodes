...
public class C02_ParamatreliConstructor {
	...
	public static void main(String[] args) {
        ...
        Car1 car2 = new Car1(35000);   // Sadece km degiþtiren bir constructor oluþturdum.
                            //int km
        
        System.out.println(car2.km);// 35000
        
        Car1 car3=new Car1(); // Parametresi int. olan bir tane constructor olabilir***,baþka olamaz. km ve yil ayrý ayrý yazamýyoruz.
        System.out.println(car3.km); // 0
        
        Car1 car4=new Car1(1000);   // burada km veya yil dememe gerek yok,diger tarata bir tane int. tanýmlanmýþ,otomatikmen km alcak       
