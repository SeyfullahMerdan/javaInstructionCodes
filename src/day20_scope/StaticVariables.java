...
public class StaticVariables {
	...
	public static void main(String[] args) {
		...
		StaticVariables obje = new StaticVariables(); // Static olmayan methodu Static olan Main methoddan çagýramayýz.
														// Bu yüzden Obje ouþturarak çagýrýyoruz.!!!
